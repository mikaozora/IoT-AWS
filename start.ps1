...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a2qt13fytv3ice-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert ppti.cert.pem --key ppti.private.key --client_id basicPubSub --topic sdk/test/python --count 0